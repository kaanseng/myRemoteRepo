...
?>
<div id="let go">
<form id="editUI" method="post" action="3.update.php">
...
<!-- <option selected value="<?php echo $rs['jobUrgent'];?>"></option> -->
<option value="普通">普通</option>
<option value="急">急</option>
<option value="急死了">急死了</option>
</select> <br>

工作說明: <textarea name="content" value="<?php echo $rs['jobContent'];?>"><?php echo $rs['jobContent'];?></textarea><br>
